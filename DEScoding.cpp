...
// DEScoding.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDEScodingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CDEScodingApp

CDEScodingApp::CDEScodingApp()
{
...
// Единственный объект CDEScodingApp

CDEScodingApp theApp;


// Инициализация CDEScodingApp

BOOL CDEScodingApp::InitInstance()
{
